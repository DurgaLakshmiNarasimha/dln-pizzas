...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      href="https://wa.me/919999999999?text=Hi! I want to order pizza from DLN Pizzas"
      target="_blank"
    ...
    >
      {/* Label */}
      <div className={`bg-[#1A1A1A] border border-green-500/30 text-white text-sm font-medium 
      ...
      <div className="w-14 h-14 bg-green-500 rounded-full flex items-center justify-center 
                      shadow-[0_4px_20px_rgba(34,197,94,0.4)] hover:shadow-[0_4px_30px_rgba(34,197,94,0.6)]
